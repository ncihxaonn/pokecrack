...
PUBLIC_STUDY_COVERAGE_FACTS = {
    ...
    b"public_study_bokunotebook_th_1": (
        ...
        b"1", b"s12a", b"all",
        b"public-study-bokunotebook-vstar-universe-v1",
        b"bokunotebook-vstar-universe-evidence-v1",
        b"575413295f78946c02ce9c97319f4688652a55d113df54b57c7fed3f626a9f31",
    ),
    b"public_study_nanjakorya_paradigm_100": (
