...
POST_PUBLIC_STUDY_GATE_SEED_V9 = POST_YOUTUBE_GATE_SEED.replace(
    b"youtube_discovery\n",
    b"youtube_discovery\n" + b"\n".join(PUBLIC_STUDY_SOURCE_KEYS_V9) + b"\n",
)
...
PUBLIC_STUDY_COVERAGE_FACTS = {
    b"public_study_nanjakorya_paradigm_100": (
        ...
        PARADIGM_POLICY.encode(), b"JP", b"Japan", b"2022-10-21 11:10:35+00",
        b"100", b"s12", b"all",
        b"public-study-nanjakorya-paradigm-v1",
        b"nanjakorya-paradigm-evidence-v1",
        b"ee845effa99200b85ff4380f16380f80aeec68a5398fc7d68a4b552c2cb16203",
    ),
    b"public_study_nanjakorya_jp_100": (
...
class BackupSanitizerTests(unittest.TestCase):
    ...
    def with_public_study_ledger(
        ...
        *rows: bytes,
        ...
        policy_ids = {
            ...
            b"public_study_cofre_lab_chilling_reign_cr_4": COSTA_RICA_POLICY,
            b"public_study_pokeyabros_perfect_order_co_2": COLOMBIA_POLICY,
    ...
    def test_public_study_accepts_exact_americas_phase_two_profile_only(self) -> None:
        dump = self.with_public_study_ledger(
            self.complete_dump(),
            comicbook_ledger_row(),
        ...
        self.assertEqual(result.returncode, 0, result.stderr.decode())
        self.assertIn(POST_PUBLIC_STUDY_GATE_SEED_V9, result.stdout)
        for study_key in (
            b"cofre-lab-chilling-reign-cr-4-v1",
            b"pokeyabros-perfect-order-co-2-v1",
            b"andree-insane-cards-cosmic-eclipse-ec-20-v1",
            ...
            self.assertIn(study_key, result.stdout)
        ...
        partial_profile = dump.replace(
            (
                f"{URUGUAY_POLICY}\t"
                "public_study_gringo_gameplays_silver_tempest_uy_36\tpolicy\n"
            ).encode(),
            b"",
            1,
        )
    ...
    def test_asian_transition_profiles_preserve_exact_rows_and_idle_gates(self) -> None:
        for profile in (PUBLIC_STUDY_SOURCE_KEYS_V10, PUBLIC_STUDY_SOURCE_KEYS_V11, PUBLIC_STUDY_SOURCE_KEYS_V12, PUBLIC_STUDY_SOURCE_KEYS_V13):
    ...
    def test_asian_coverage_backup_drift_fails_without_output(self) -> None:
        profile = PUBLIC_STUDY_SOURCE_KEYS_V13
        base = self.with_public_study_ledger(
            self.complete_dump(), comicbook_ledger_row(), source_keys=profile,
        )
        for key in (b"public_study_garbage_rips_cn_1", b"public_study_bikuhime_id_20", b"public_study_nanjakorya_jp_100", b"public_study_nanjakorya_paradigm_100"):
