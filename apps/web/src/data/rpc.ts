...
export const PUBLIC_STUDY_COVERAGE_RPC = "get_public_study_coverage_v4" as const;
export const PUBLIC_STUDY_COVERAGE_FALLBACK_RPC =
  "get_public_study_coverage_v3" as const;
export const PUBLIC_STUDY_COVERAGE_LEGACY_RPC =
  "get_public_study_coverage_v2" as const;
export const PUBLIC_STUDY_COVERAGE_OLDEST_RPC = "get_public_study_coverage_v1" as const;
