export const PUBLIC_DASHBOARD_RPC = "get_public_dashboard_snapshot_v4" as const;
export const PUBLIC_STUDY_COVERAGE_RPC = "get_public_study_coverage_v1" as const;
export const PUBLIC_SOCIAL_DISCOVERY_RPC = "get_public_social_discovery_v2" as const;
