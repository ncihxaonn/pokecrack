  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", padding: "42px", color: "#171a21", background: "#f3f4f7", fontFamily: "sans-serif" }}>
      <div style={{ position: "relative", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", overflow: "hidden", border: "1px solid #e2e5eb", borderRadius: 34, padding: "42px 48px", background: "#ffffff", boxShadow: "0 18px 50px rgba(23,26,33,.08)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 710 }}><span style={{ color: "#315efb", fontSize: 18, fontWeight: 750, letterSpacing: 3, textTransform: "uppercase" }}>Observed regional pull map · Australia</span><span style={{ marginTop: 20, fontSize: 66, fontWeight: 760, lineHeight: 1.03, letterSpacing: -3 }}>{BRAND.tagline}</span><span style={{ marginTop: 24, color: "#667085", fontSize: 23, lineHeight: 1.4 }}>Evidence-led Pokémon TCG observations, visualised without predictive claims.</span></div>
