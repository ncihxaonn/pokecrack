  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", padding: "42px", color: "#101512", background: "#f2f6f3", fontFamily: "sans-serif" }}>
      <div style={{ position: "relative", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", overflow: "hidden", border: "1px solid #cad4cc", borderRadius: 34, padding: "42px 48px", background: "#ffffff", boxShadow: "0 18px 50px rgba(16,21,18,.07)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 710 }}><span style={{ color: "#0d7444", fontSize: 18, fontWeight: 750, letterSpacing: 3, textTransform: "uppercase" }}>Worldwide qualifying-hit atlas</span><span style={{ marginTop: 20, fontSize: 66, fontWeight: 760, lineHeight: 1.03, letterSpacing: -3 }}>{BRAND.tagline}</span><span style={{ marginTop: 24, color: "#5e6962", fontSize: 23, lineHeight: 1.4 }}>Country-level Pokémon TCG observations, visualised without predictive claims.</span></div>
