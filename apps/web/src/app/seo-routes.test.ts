...
describe("SEO metadata routes", () => {
  ...
  it("sets canonical, Open Graph, Twitter and 15-minute public revalidation metadata", () => {
    ...
    const pages = ["page.tsx", "sets/page.tsx", "regions/page.tsx", "retailers/page.tsx", "batches/page.tsx", "methodology/page.tsx", "sources/page.tsx", "status/page.tsx"];
    for (const page of pages) expect(readFileSync(path.join(appRoot, page), "utf8"), page).toContain("export const revalidate = 900");
  });
});
